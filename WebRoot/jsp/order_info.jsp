...
<html>
	...
	<%@include file="header.jsp" %>
		...
		<div class="container">
						...
						<tbody>
							...
							<c:forEach var="ci" items="${cart.cartItems}" begin="0" step="1">
								<tr class="active">
									...
									<td width="15%">
										<span class="subtotal">￥${ci.price}</span>
									</td>
								</tr>
			...
			<div>
				<hr/>
				<form method="post" action="${pageContext.request.contextPath }/orderinfo?method=saveorder" class="form-horizontal" style="margin-top:5px;margin-left:150px;" >
