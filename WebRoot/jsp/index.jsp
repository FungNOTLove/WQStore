		...
		<div class="container-fluid">
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="${pageContext.request.contextPath}/img/1.jpg" style="width: 100%;height: 500px;">
							<div class="carousel-caption">

							</div>
						</div>
						<div class="item" >
							<img src="${pageContext.request.contextPath}/img/2.jpg" style="width: 100%;height: 500px;">
							<div class="carousel-caption">

							</div>
						</div>
						<div class="item">
							<img src="${pageContext.request.contextPath}/img/3.jpg" style="width: 100%;height: 500px;">
							<div class="carousel-caption">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach var="product" items="${hotproduct}" begin="0" step="1">
